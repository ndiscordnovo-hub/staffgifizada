...
export const SIZE_PRESETS = [
  { id: "discord-avatar", label: "Avatar Discord", w: 512, h: 512, group: "Discord" },
  ...
  { id: "discord-server-icon", label: "Ícone de Servidor", w: 512, h: 512, group: "Discord" },
  { id: "instagram", label: "Instagram Post", w: 1080, h: 1080, group: "Social" },
  { id: "instagram-story", label: "Instagram Story", w: 1080, h: 1920, group: "Social" },
  { id: "youtube", label: "YouTube Thumb", w: 1280, h: 720, group: "Social" },
  { id: "tiktok", label: "TikTok", w: 1080, h: 1920, group: "Social" },
...
export const DISCORD_INVITE = "https://discord.gg/staffgifizada";
export const SITE_NAME = "Nebula Studio";
