    ...
    <div className="max-w-3xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-white flex items-center gap-2">
          <FileText className="h-6 w-6 text-brand-300" /> Termos de Uso
        </h1>
      ...
      <div className="card p-6 space-y-5 text-sm leading-relaxed text-white/70">
        <section>
          <h2 className="text-white font-semibold mb-1.5">1. Sobre o serviço</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold mb-1.5">2. Uso aceitável</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold mb-1.5">3. Sem garantias</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold mb-1.5">4. Limitação de responsabilidade</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold mb-1.5">5. Propriedade do conteúdo</h2>
          <p>
        ...
        <section>
          <h2 className="text-white font-semibold mb-1.5">6. Alterações</h2>
          <p>
